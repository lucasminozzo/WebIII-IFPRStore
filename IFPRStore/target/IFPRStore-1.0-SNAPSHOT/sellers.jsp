...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:8080/IFPRStore_war_exploded//css/dashboard.css">
</head>
<body class="bg-light">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <tr>
                        ...
                        <td><%=seller.getName()%>
                        <td><%=seller.getEmail()%>
                        <td><%=seller.getBirthDate()%>
                        <td><%=seller.getBaseSalary()%>
                        <td><%=seller.getDepartment()%>
                        <td>
