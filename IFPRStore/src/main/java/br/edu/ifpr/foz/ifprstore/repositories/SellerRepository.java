        ...
        try {
            ...
            while(result.next()) {
               ...
               /* try {
                    ...
                    departments.setId(department.getDepartments());
...
//                System.out.println("BirthDate: " + result.getString("BirthDate"));
//                System.out.println("BaseSalary: " + result.getDouble("BaseSalary"));
